...
export default function BlogPost() {
  return (
    <>
      <Head>
        <StaticContent element="title" key="title" data-th-text="${post.title}">
          Blog post
        </StaticContent>
      </Head>
      <StaticContent element="div">
        <header
          ...
          data-th-style="${'background-image: url(' + (#strings.isEmpty(post.imageUrl) ? #webapp.path('@static:/nextjs/img/about-bg.jpg') : post.imageUrl) + ')'}"
        >
          <div className="container">
            <div className="row">
              <div className="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div className="post-heading">
                  <h1 data-th-text="${post.title}">
